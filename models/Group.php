...
class Group extends Model
{
    ...
    {
        if (strlen((string) $name) < 20 && strlen((string) $name) > 0) {
            $this->_name = $name;
        } else {
            $this->_errors['name'] = "Le nom du groupe n'est pas valide";
        }
    ...
    /**
     * Set the value of _members
     *
     * @return  self
     */ 
    public function setMembers(array $_members)
    {
